<template>
  <div>
<!--    <div v-if="props.slug" >
    <nuxt-link class="hover:underline" :to="'/player/'+props.slug">{{props.name}}</nuxt-link>
  </div>
  <div v-else>
    {{props.name}}
  </div>-->
    ...
    <template v-if="props.slug">
      <nuxt-link class="hover:underline" :to="'/player/'+props.slug">
        <div class="flex items-center">
          ...
          <span :class="fontSz">{{ props.name }}</span>
        </div>
      </nuxt-link>
    </template>
